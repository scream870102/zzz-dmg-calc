...
最近一次驗證：89 項數值與離線檢查，加上桌面、手機各 61 項互動／版面檢查，共 211 項通過。
...
公式核對日期為 2026-09-18。特殊公式依玩家實測整理；多人混合積蓄未提供自動計算。浮點計算結果於顯示時四捨五入，遊戲版本、角色機制與實際情境可能影響結果。各模式的詳細假設與限制請見網頁中的「來源與範圍」。
